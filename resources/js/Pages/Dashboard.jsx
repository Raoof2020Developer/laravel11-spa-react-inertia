...
export default function Dashboard({
    auth,
    totalPendingTasks,
    myPendingTasks, totalInProgressTasks,
    myInProgressTasks,
    totalCompletedTasks,
    myCompletedTasks,
    myActiveTasks }) {
    return (
        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-3 gap-10">
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8  mt-4">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <h3 className="text-gray-200 text-2xl font-semibold mb-5">
                                My Active Tasks
                            </h3>
                                    ...
                                    {myActiveTasks.data.map(task => (
                                        <tr key={task.id}>
                                            ...
                                            <td className="px-3 py-2">
                                                <span
                                                    className={
                                                        'px-2 py-1 rounded text-nowrap text-white ' + TASK_STATUS_CLASS_MAP[task.status]
                                                    }
                                                    >
